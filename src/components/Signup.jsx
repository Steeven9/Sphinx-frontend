            ...
            <div className="signup">
                ...
                <div class="content-box1">
                    ...
                    <div class="dates">
                        ...
                        <div class="dates-input"><input class="cred" type="email" name="" placeholder="Email" /></div>

                        <div class="dates-input"><input class="cred" type="text" name="" placeholder="Username" /></div>

                        <div class="dates-input"><input class="cred" type="password" name="" placeholder="Password*" /></div>

                        <div class="dates-input"><input class="cred" type="password" name="" placeholder="Confirm*" /></div>
