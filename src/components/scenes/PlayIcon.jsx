    ...
    return (
        <>
            ...
            <img alt="scene play circle 1"
                 className={!playing ? "hidden" : "scene-item btn-icon-rotate-clockwise-over-1 btn-icon-rotate-clockwise-1"}
                 src="/img/icons/material-ui-svg/PlayCircleOutline1.svg"/>
            <img alt="scene play circle 2"
                 className={!playing ? "hidden" : "scene-item btn-icon-rotate-clockwise-over-2 btn-icon-rotate-clockwise-2"}
                 src="/img/icons/material-ui-svg/PlayCircleOutline2.svg"/>
            <img alt="scene play circle 3"
                 className={!playing ? "hidden" : "scene-item btn-icon-rotate-clockwise-over-3 btn-icon-rotate-clockwise-3"}
                 src="/img/icons/material-ui-svg/PlayCircleOutline3.svg"/>
            <img alt="scene play circle 4"
                 className={!playing ? "hidden" : "scene-item btn-icon-rotate-clockwise-over-4 btn-icon-rotate-clockwise-4"}
