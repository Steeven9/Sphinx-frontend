                    ...
                    <main>
                        <article>
                            ...
                            <section className="home-content-box z-depth-2">
                                ...
                                <p>
                                    <strong>SmartHut</strong> is your one-stop management system for all your smart lights and sensors in your home,
                                    independently from their manufacturer.
                                </p>

                                <p>
                                    Using <strong>SmartHut</strong> is as easy as creating rooms and then adding all your devices to them.
