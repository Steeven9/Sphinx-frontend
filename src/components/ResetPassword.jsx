        ...
        return (
            <div className="resetPassword">
                ...
                <div class="content-box1">
                    ...
                    <div class="dates-input1"><input type="text" name="" placeholder="Email"/></div>

                    <div class="buttons1">

                        <div class="dates-input1"><a href="/login"><button type="button" name="button" class="btn-secondary btn">Cancel</button></a></div>

                        <div class="dates-input1"><button type="button" name="button" class="btn-primary btn">Reset password</button></div>
